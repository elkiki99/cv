...
$classes = Flux::classes()
    ...
    ->add($variant === 'solid' ? match ($color) {
        ...
        default => 'text-zinc-700 [&_button]:!text-zinc-700 dark:text-zinc-200 [&_button]:dark:!text-zinc-200 bg-zinc-400/15 dark:bg-zinc-400/15 [&:is(button)]:hover:bg-zinc-400/25 [&:is(button)]:hover:dark:bg-zinc-400/50',
...
<flux:button-or-div :attributes="$attributes->class($classes)" data-flux-badge>
    ...
    <?php if ($iconTrailing): ?>
        <div class="flex items-center pl-1" data-flux-badge-icon-trailing>
