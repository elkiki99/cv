...
<svg {{ $attributes->class($classes) }} data-flux-icon aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
    ...
    <path fill="currentColor" d="M71.357 460.819 30.272 0h451.456l-41.129 460.746L255.724 512z" />
    <path fill="currentColor" d="m405.388 431.408 35.148-393.73H256v435.146z" />
    ...
    <path class="transition-[group-hover] duration-200 group-hover:fill-zinc-100 dark:group-hover:fill-zinc-800 fill-white dark:fill-zinc-900"
        ...
        class="transition-[group-hover] duration-200 group-hover:fill-zinc-100 dark:group-hover:fill-zinc-800 fill-white dark:fill-zinc-900" />
</svg>
