...
<svg {{ $attributes->class($classes) }} data-flux-icon aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
    ...
    <path
        ...
        fill="currentColor" />
    {{-- <path d="M157.9 10H17C7.7 10 0 17.7 0 27v155.2c0 9.4 7.7 17.2 17.1 17.2h92.7c-1-46.2 14.7-135.7 48-189.5Z"
    ...
    <path d="M152.8 15H17C10.5 15 5 20.4 5 27V171c30.7-11.8 76.8-22 108.7-21.5a989.7 989.7 0 0 1 39-134.5Z"
        class="transition-[group-hover] duration-200 group-hover:fill-zinc-100 dark:group-hover:fill-zinc-800 fill-white dark:fill-zinc-900" /> --}}
    <path
