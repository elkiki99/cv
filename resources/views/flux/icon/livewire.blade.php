...
<svg {{ $attributes->class($classes) }} data-flux-icon aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
    ...
    <!-- Outter body -->
    <path class="transition-[group-hover] duration-200 group-hover:fill-zinc-100 dark:group-hover:fill-zinc-800 fill-white dark:fill-zinc-900" style="fill-rule:evenodd;"
    ...
    <!-- Legs -->
    <path fill="currentColor" style="fill-rule:evenodd;"
